...
def post_to_database(date, drive_name, num_infected_files):
    ...
    # secret_key = HTTPBasicAuth('apikey', 'GDSEC-ZDIxZTg5ZTYyMTQ2YTFhMzJlNGIzMmE3OGRkZWM4MjZkYmEyMDBhNzA4YjVhYTQw')
    secret_key = "GDSEC-ZDIxZTg5ZTYyMTQ2YTFhMzJlNGIzMmE3OGRkZWM4MjZkYmEyMDBhNzA4YjVhYTQw"
